    ...
    return (
        <div style={pageContainerStyle}>
            ...
            <div style={containerStyle}>
                ...
                {/* Social buttons are removed as they weren't styled and are not typical for admin login */}
                {/* If you want to keep them, you would need to style them inline */}
                ...
                <form onSubmit={submitHandler}>
                    <div style={formGroupStyle}>
                        ...
                        <input
                            type="text"
                            name="email"
                            className="form-control" // You can keep bootstrap classes if they don't conflict, but inline styles take precedence
                    ...
                    <div style={formGroupStyle}>
                        ...
                        <input
                            ...
                            name="password"
                            onChange={dataHandler}
                             className="form-control" // Keep bootstrap class if needed
                    ...
                    {/* Forgot password link - remove or style inline if needed */}
                    {/* <div className="d-flex justify-content-between align-items-center mb-3">
                        <a href="#" style={linkStyle} onMouseOver={(e) => Object.assign(e.target.style, {...linkStyle, ...linkHoverStyle})} onMouseOut={(e) => Object.assign(e.target.style, linkStyle)}>Forgot password?</a>
                    </div> */}
                    ...
                    {/* Removed the "Don't have an account? Sign up" link as it's not typical for an admin login page. */}
                    {/* If you want to keep it, style it inline using linkStyle */}
                    {/* <div style={{ marginTop: '20px', textAlign: 'center', fontSize: '1rem', color: secondaryColor }}>
                        <span>Don’t have an account? </span>
                        <Link to="/signup" style={linkStyle} onMouseOver={(e) => Object.assign(e.target.style, {...linkStyle, ...linkHoverStyle})} onMouseOut={(e) => Object.assign(e.target.style, linkStyle)}>Sign up</Link>
                    </div> */}
                </form>
            </div>
        </div>
